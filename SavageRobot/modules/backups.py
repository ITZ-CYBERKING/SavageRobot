...
import SavageRobot.modules.sql.notes_sql as sql
from SavageRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SavageRobot.__main__ import DATA_IMPORT
from SavageRobot.modules.helper_funcs.chat_status import user_admin
from SavageRobot.modules.helper_funcs.alternate import typing_action

# from SavageRobot.modules.rules import get_rules
import SavageRobot.modules.sql.rules_sql as rulessql

# from SavageRobot.modules.sql import warns_sql as warnssql
import SavageRobot.modules.sql.blacklist_sql as blacklistsql
from SavageRobot.modules.sql import disable_sql as disabledsql

# from SavageRobot.modules.sql import cust_filters_sql as filtersql
# import SavageRobot.modules.sql.welcome_sql as welcsql
import SavageRobot.modules.sql.locks_sql as locksql
from SavageRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    os.remove("AsunaRobot{}.AsunaRobot".format(chat_id))  # Cleaning file
