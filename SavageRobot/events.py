...
from SavageRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"SavageRobot/modules/{shortname}.py")
        name = "SavageRobot.modules.{}".format(shortname)
        ...
        mod.SavageRobot = SavageRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["SavageRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "SavageRobot/modules/*.py"
